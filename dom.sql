...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Ápr 07. 12:26
...
--
-- Tábla szerkezet ehhez a táblához `csunya_szavak`
--

CREATE TABLE `csunya_szavak` (
  `id` int(11) NOT NULL,
  `szo` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- A tábla adatainak kiíratása `csunya_szavak`
--

INSERT INTO `csunya_szavak` (`id`, `szo`) VALUES
(1, 'hülye'),
(2, 'buta'),
(3, 'idiota');
...
--
-- A tábla indexei `csunya_szavak`
--
ALTER TABLE `csunya_szavak`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT a táblához `csunya_szavak`
--
ALTER TABLE `csunya_szavak`
...
--
ALTER TABLE `felhasznalok`
  ADD CONSTRAINT `felhasznalok_ibfk_1` FOREIGN KEY (`id`) REFERENCES `bejegyzesek` (`felhasznalo_id`);
