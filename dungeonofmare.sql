...
--
-- Gép: 127.0.0.1:3307
-- Létrehozás ideje: 2026. Feb 05. 12:07
...
--
-- Tábla szerkezet ehhez a táblához `szoba_targyak`
--

CREATE TABLE `szoba_targyak` (
  `id` int(11) NOT NULL,
  `szoba_id` int(11) NOT NULL,
  `targy_id` int(11) NOT NULL,
  `felveheto` tinyint(1) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `targyak` (
  ...
  `ritkasag` enum('common','uncommon','rare','epic','legendary') DEFAULT NULL,
  `sebzes` int(11) DEFAULT 0,
  `vedelem` int(11) DEFAULT 0,
  `gyogyitas` int(11) DEFAULT 0,
...
--
-- Tábla szerkezet ehhez a táblához `targy_tipusok`
--

CREATE TABLE `targy_tipusok` (
  `tipus_id` int(11) NOT NULL,
...
--
-- A tábla indexei `szoba_targyak`
--
ALTER TABLE `szoba_targyak`
  ADD PRIMARY KEY (`id`),
...
--
-- A tábla indexei `targy_tipusok`
--
ALTER TABLE `targy_tipusok`
...
--
-- AUTO_INCREMENT a táblához `szoba_targyak`
--
ALTER TABLE `szoba_targyak`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT a táblához `targy_tipusok`
--
ALTER TABLE `targy_tipusok`
  MODIFY `tipus_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Megkötések a táblához `szoba_targyak`
--
ALTER TABLE `szoba_targyak`
  ADD CONSTRAINT `szoba_targyak_ibfk_1` FOREIGN KEY (`szoba_id`) REFERENCES `szobak` (`szoba_id`),
  ADD CONSTRAINT `szoba_targyak_ibfk_2` FOREIGN KEY (`targy_id`) REFERENCES `targyak` (`targy_id`);
...
--
-- Megkötések a táblához `targyak`
--
ALTER TABLE `targyak`
  ADD CONSTRAINT `targyak_ibfk_1` FOREIGN KEY (`tipus_id`) REFERENCES `targy_tipusok` (`tipus_id`);
COMMIT;
