...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Jan 18. 17:01
...
--
-- Tábla szerkezet ehhez a táblához `interakciok`
--

CREATE TABLE `interakciok` (
...
--
-- A tábla indexei `interakciok`
--
ALTER TABLE `interakciok`
...
--
-- AUTO_INCREMENT a táblához `interakciok`
--
ALTER TABLE `interakciok`
  MODIFY `interakcio_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Megkötések a táblához `interakciok`
--
ALTER TABLE `interakciok`
  ADD CONSTRAINT `interakciok_ibfk_1` FOREIGN KEY (`futam_id`) REFERENCES `futamok` (`futam_id`),
  ADD CONSTRAINT `interakciok_ibfk_2` FOREIGN KEY (`szoba_id`) REFERENCES `szobak` (`szoba_id`);
